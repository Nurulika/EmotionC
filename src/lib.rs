...
#[derive(Debug)]
pub struct EmotionCSSProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EmotionCSSProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EmotionCSS processing");
    
    let mut processor = EmotionCSSProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EmotionCSSProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EmotionCSSProcessor::new(false);
